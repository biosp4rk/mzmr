    ...
    private static readonly byte[] musicList = //list of valid music IDs
        {
                ...
                0x40, 0x41, 0x44, 0x45, 0x46, 0x49, 0x4B, 0x4E, 0x53, 0x5A
        };
        ...
        private void RandomizeRoomMusicNoLogic()
        {
            ...
            for (int i = 0; i < roomCount; i++)
            {
                ...
                rom.Write8(0x340B0E + (0x3C * i) + 1, 0);
            }
        }
        ...
        private void RandomizeRoomMusicLogic()
        {
            ...
            byte[] roomReplacemnts = { 01, 02, 03, 05, 06, 07, 09, 0xA, 0xB, 0xC, 0xD, 0xE, 0xF, 0x17, 0x19,
                0x1A, 0x1B, 0x32, 0x3B, 0x3D, 0x44, 0x50, 0x53, 0x54, 0x5A, 0x5B, 0x5C, 0x5E };
            int index;
